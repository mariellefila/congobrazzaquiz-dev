...
function initAdCarousels() {
  const carousels = document.querySelectorAll('[data-ad-carousel], [data-category-ad-carousel], [data-result-ad-carousel]');

  carousels.forEach((carousel) => {
    if (carousel.dataset.adCarouselReady === 'true') return;
    carousel.dataset.adCarouselReady = 'true';
...
initAdCarousels();
window.initAdCarousels = initAdCarousels;